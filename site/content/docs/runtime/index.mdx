...
| Node line | Minimum Nub supports | Fast-tier floor | Tier |
|---|---|---|---|
| 18.x | 18.19 | — | Compatibility (no `registerHooks`) |
| 20.x | all 20.x | — | Compatibility (`registerHooks` never backported to 20) |
| 22.x | all 22.x | 22.15 | Fast at 22.15+, compatibility on 22.0–22.14 |
| 23.x | all 23.x | 23.5 | Fast at 23.5+, compatibility on 23.0–23.4 |
| 24.x | all 24.x | 24.0 | Fast (whole line) |
| 25.x | all 25.x | 25.0 | Fast (whole line) |
| 26.x | all 26.x | 26.0 | Fast (whole line) |

A dash in the fast-tier column means that line has no fast-tier build — every patch runs in the compatibility tier. Both tiers are fully supported; nothing about your code changes between them.
